...
const pentomino = ["62,35","62,34","61,34","62,33","63,33"];
...
const GOSPER_GLIDER_GUN = {
    ...
    data: new Set(shiftCells(gosperGliderGun, 10,10))
};
...
const R_PENTOMINO = {
    title:"R-Pentomino",
    data: new Set(shiftCells(pentomino, -50, -20))
};

const BLOCK = {
    title:"Block",
    data: new Set(["10,10","10,11","11,10","11,11"])
};
